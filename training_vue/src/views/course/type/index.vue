    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="类型描述" prop="typeDescribe">
          <el-input v-model="form.typeDescribe" placeholder="请输入类型描述" />
        </el-form-item>
...
<script>
import { listType, getType, delType, addType, updateType, exportType } from "@/api/course/type";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除课程类型编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有课程类型数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
